...
#define DXL_STATUS_PACKET_PARAM_POS        (DXL_STATUS_PACKET_ERR_POS + DXL_PACKET_ERR_LEN)
#define DXL_STATUS_PACKET_CRC_POS(packet_len)                                                      \
	(DXL_STATUS_PACKET_INST_POS + (packet_len) - DXL_PACKET_CRC_LEN)
...
#define DXL_STATUS_PACKET_LEN(packet_len)                                                          \
	(DXL_STATUS_PACKET_CRC_POS(packet_len) + DXL_PACKET_CRC_LEN)
