...
#define DXL_PACKET_CHKSUM_LEN 1
...
#define DXL_STATUS_PACKET_CHKSUM_POS(packet_len)                                                   \
	(DXL_STATUS_PACKET_PARAM_POS + (packet_len) - DXL_PACKET_CHKSUM_LEN)

// Packet lengths (not the value in the frame, but the total length of the frame).
#define DXL_INST_PACKET_LEN(param_len)                                                             \
	(DXL_INST_PACKET_CHKSUM_POS(param_len) + DXL_PACKET_CHKSUM_LEN)
#define DXL_STATUS_PACKET_LEN(packet_len)                                                          \
	(DXL_STATUS_PACKET_CHKSUM_POS(packet_len) + DXL_PACKET_CHKSUM_LEN)
